...
epochs = 20
history = model.fit(train_it, validation_data=dev_it,
                    epochs=epochs, callbacks=[tboard_callback])
model.save('data/Xception_transfer_mask.h5')
...
epochs = 10
history2 = model.fit(train_it, validation_data=dev_it,
                     epochs=epochs, callbacks=[tboard_callback])
model.save('data/Xception_transfer_mask_2.h5')
