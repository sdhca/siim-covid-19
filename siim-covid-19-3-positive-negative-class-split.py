...
output_path = Path('image_files/2-classes/')
...
# %%
def sort_images_into_2_classes(data_df, input_path, output_path, data_split_name='train'):
    # Create output directories
    base_dir = 'png_2-class_1024x1024'
...
# %%
sort_images_into_2_classes(train_df, input_path/'train_png', output_path, 'train')
sort_images_into_2_classes(dev_df, input_path/'dev_png', output_path, 'dev')
# %%
